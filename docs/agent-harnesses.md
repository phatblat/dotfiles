...
| Feature | Category | Priority | Claude | Codex | OpenCode | Pi | OMP | Antigravity | Cursor | Grok | Next action |
|---|---|---|---|---|---|---|---|---|---|---|---|
| instructions.global | instructions | p0 | complete / shared | complete / shared | complete / shared | complete / shared | complete / native | partial / adapter | partial / adapter | complete / native | Install or import the Antigravity plugin and verify it loads shared harness instructions; Link or install the Cursor plugin and verify Cursor loads the shared-harness rule |
| skills.shared | skills | p0 | complete / shared | complete / shared | complete / shared | complete / shared | complete / native | partial / adapter | partial / native | complete / native | Verify Cursor discovers and activates generated shared skill wrappers; Verify agy imports and activates shared skill wrappers from the plugin |
...
| clangd-lsp@claude-plugins-official | disabled | enabled |
