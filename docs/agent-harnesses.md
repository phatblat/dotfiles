...
|---|---|---|---|---|---|---|---|---|---|---|
| instructions.global | instructions | p0 | complete / shared | complete / shared | complete / shared | complete / shared | complete / native | partial / adapter | partial / adapter | Install or import the Antigravity plugin and verify it loads shared harness instructions; Link or install the Cursor plugin and verify Cursor loads the shared-harness rule |
...
| commands.active | commands | p0 | complete / native | blocked / adapter | complete / adapter | complete / adapter | complete / native | partial / adapter | partial / native | Re-check Codex release notes for stable command format; Verify Antigravity command schema or flatten command wrappers so all 25 commands are discovered; Verify Cursor discovers all 25 generated command wrappers |
| agents.specialists | agents | p0 | complete / native | complete / native | complete / adapter | partial / emulated | complete / native | partial / emulated | partial / native | Implement subprocess delegation in ~/.pi/agent/extensions/harness.ts per policy; Verify Antigravity can delegate to generated specialist wrappers with isolated context; Verify Cursor discovers generated specialist agent wrappers |
| hooks.safety | hooks | p0 | complete / adapter | complete / adapter | complete / adapter | complete / adapter | complete / adapter | partial / adapter | partial / adapter | Verify Antigravity invokes hooks.json before shell/write/edit calls and blocks on deny; Verify Cursor invokes hooks.json before shell/write/edit calls and blocks on deny |
...
| maintenance.audit | maintenance | p1 | complete / shared | complete / shared | complete / shared | complete / shared | complete / shared | complete / shared | complete / shared | - |
