...
| sessions.compaction | sessions/compaction | p1 | complete / native | complete / native | complete / adapter | complete / native | partial / native | partial / native | partial / native | Encode the compaction preservation contract in ~/.omp/agent/APPEND_SYSTEM.md; Verify Antigravity conversation and artifact persistence behavior against compact-preservation requirements; Verify Cursor resume and history behavior against compact-preservation requirements |
