...
| antigravity | partial | adapter | - | probe · 1.2.10 · 2026-09-26 | generated Antigravity skill wrappers point to shared skills, but runtime import has not been verified |
| cursor | partial | native | - | probe · 2026.09.15-d2fe57e · 2026-09-26 | generated Cursor plugin skill wrappers point to shared skills, but runtime discovery has not been verified |
| grok | aligned | native | - | probe · grok 1.0.41 (4220f3b224a6) [alpha] · 2026-09-26 | grok scans ~/.agents/skills at the user tier |
| crush | aligned | native | - | probe · crush version v0.96.1 · 2026-09-26 | generated crushrc adds ~/.agents/skills through option skill-path; crush's default global skill roots are ~/.config/crush/skills and ~/.config/agents/skills, so the shared root is named explicitly |
