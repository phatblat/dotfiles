...
- [ ] Model identifiers match provider documentation (e.g., `gpt-5`, `Codex-opus-4.1`)
...
├─ Quality → gpt-5 or Codex-opus-4.1
...
- `@ai-sdk/anthropic`: Anthropic Codex integration  
