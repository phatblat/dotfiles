...
GROK = ROOT / ".grok"
HARNESSES = ["claude", "codex", "opencode", "pi", "omp", "antigravity", "cursor", "grok"]
...
def render_claude_skill(skill_name: str, *, manual_only: bool) -> str:
    ...
    return f"""---
name: {skill_name}
description: Load the shared skill from ~/.agents/skills/{skill_name}/SKILL.md{manual_metadata}
---
