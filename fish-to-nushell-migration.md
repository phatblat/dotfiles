...
- `branch.fish` - git branch operations
- `checkout.fish` - git checkout
...
- `init.fish` - git init
- `lfs.fish` - git lfs
- `lg.fish` - git log graph
- `lg1.fish` - git log oneline
- `lg10.fish` - git log 10 commits
