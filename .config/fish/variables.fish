...
# GOPATH - where to download Go packages
if not set -q GOPATH
    set --export GOPATH $HOME/go
end

# /Users/phatblat/.local/share/mise/installs/go/1.25.0/bin
set --export GOROOT (mise bin-paths | rg go | head -1 | string replace '/bin' '')
