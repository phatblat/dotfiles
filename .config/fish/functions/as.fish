function as \
    ...
    set -l bumblebee    ch-0/211.7628.21.2111.8139111 # patch 1
    ...
    set -l app ~/Library/Application\ Support/JetBrains/Toolbox/apps/AndroidStudio/$bumblebee/Android\ Studio.app
