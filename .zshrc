...
# genv, gt, jq, log, pkginfo, pp, reset, sha256, sync, wt). Claude Code's shell-snapshot
...
autoload -Uz +X aa bq cc dash dc diff fork genv gt jq log omp pkginfo pp reset sha256 sync wt 2>/dev/null
